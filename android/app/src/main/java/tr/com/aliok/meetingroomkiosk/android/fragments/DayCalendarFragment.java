 ...
 * {@link DayCalendarFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link DayCalendarFragment#newInstance} factory method to
...
public class DayCalendarFragment extends Fragment {
     ...
     * @return A new instance of fragment dayCalendar.
     */
    // TODO: Rename and change types and number of parameters
    public static DayCalendarFragment newInstance(String param1, String param2) {
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onDayCalendarFragmentInteraction(uri);
        }
    }
