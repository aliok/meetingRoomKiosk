...
public class ScheduleServiceClient {
    ...
    public Schedule fetchSchedule() {
        ...
        final Date today_1330 = DateUtils.addMinutes(DateUtils.addHours(today_00oclock, 13), 30);
        final Date today_14oclock = DateUtils.addHours(today_00oclock, 14);
        ...
        final Event event2 = new Event.EventBuilder()
                .setEventId(192102L)
                .setAllDayEvent(false)
                .setAttendees(Arrays.asList(attendee1, attendee2))
                .setEventDescription("Innbound Sprint Retrospective meeting and review meeting")
                .setOrganizer(organizer1)
                .setEventStart(today_1330)
                .setEventEnd(today_14oclock)
                .createEvent();
